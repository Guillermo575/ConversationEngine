...
namespace ConversationEditor.Setup
{
    ...
    public class ConversationEditorSetup : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            DrawStatusBox("Newtonsoft.Json Package", newtonsoftInstalled, "Required for JSON serialization", 
            ...
            DrawStatusBox("Assembly Definitions", assemblyDefsValid,
                          "Ensures proper script compilation", "Assembly definition files should reference Unity.Newtonsoft.Json");
            EditorGUILayout.Space();
            // Example Files Check
            DrawStatusBox("Example Files", exampleFilesPresent, "Example conversation files for reference", 
